import 'dart:async';
import 'package:pulo_riders_app/methods/common_methods.dart';
import 'package:pulo_riders_app/methods/map_theme_methods.dart';
import 'package:pulo_riders_app/models/trip_details.dart';
import 'package:pulo_riders_app/widgets/payment_dialog.dart';
...
class _NewTripPageState extends State<NewTripPage>
{
  ...
  makeMarker()
  {
    if(carMarkerIcon == null)
    {
      ...
      BitmapDescriptor.fromAssetImage(configuration, "assets/images/tracking_riders.png")
          .then((valueIcon)
      {
  ...
  getLiveLocationUpdatesOfDriver()
  {
    ...
    positionStreamNewTripPage = Geolocator.getPositionStream().listen((Position positionDriver)
    {
      ...
      FirebaseDatabase.instance.ref().child("tripRequestsRider")
  ...
  endTripNow() async
  {
    ...
    await FirebaseDatabase.instance.ref().child("tripRequestsRider")
        .child(widget.newTripDetailsInfo!.tripID!)
  ...
  saveDriverDataToTripInfo() async
  {
    Map<String, dynamic> driverDataMap =
    {
      ...
      "driverPhoto": riderPhoto,
      "carDetails": motorCycleColor + " - " + motorCycleModel + " - " + motorCycleNumber,
    };
