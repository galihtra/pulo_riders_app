...
import 'package:pulo_riders_app/pushNotification/push_notification_system.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  retrieveCurrentDriverInfo() async
  {
        ...
        .once().then((snap)
    {
      ...
      motorCycleColor = (snap.snapshot.value as Map)["motorcycle_details"]["motorcycleColor"];
      motorCycleModel = (snap.snapshot.value as Map)["motorcycle_details"]["motorcycleModel"];
      motorCycleNumber = (snap.snapshot.value as Map)["motorcycle_details"]["motorcycleNumber"];
    });
