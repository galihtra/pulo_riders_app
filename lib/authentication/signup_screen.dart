...
import 'package:pulo_riders_app/pages/dashboard.dart';
...
class _SignUpScreenState extends State<SignUpScreen>
{
  ...
  signUpFormValidation()
  {
    ...
    {
      cMethods.displaySnackBar("please write your motorcycle model", context);
    }
    else if(vehicleColorTextEditingController.text.trim().isEmpty)
    {
      cMethods.displaySnackBar("please write your motorcycle color.", context);
    }
    else if(vehicleNumberTextEditingController.text.isEmpty)
    {
      cMethods.displaySnackBar("please write your motorcycle number.", context);
    }
    else
    {
  ...
  registerNewDriver() async
  {
    ...
    DatabaseReference usersRef = FirebaseDatabase.instance.ref().child("riders").child(userFirebase!.uid);

    Map drivermotorcycleInfo =
    {
      "motorcycleColor": vehicleColorTextEditingController.text.trim(),
      "motorcycleModel": vehicleModelTextEditingController.text.trim(),
      "motorcycleNumber": vehicleNumberTextEditingController.text.trim(),
    };

    Map driverDataMap =
    {
      "photo": urlOfUploadedImage,
      "motorcycle_details": drivermotorcycleInfo,
                ...
                child: Column(
                  children: [
                    ...
                    TextField(
                      ...
                      keyboardType: TextInputType.text,
                      decoration: const InputDecoration(
                        labelText: "your MotorCycle Model",
                        labelStyle: TextStyle(
                          fontSize: 14,
                        ),
                      ),
                    ...
                    TextField(
                      ...
                      keyboardType: TextInputType.text,
                      decoration: const InputDecoration(
                        labelText: "your Motorcycle Color",
                        labelStyle: TextStyle(
                          fontSize: 14,
                        ),
                      ),
                    ...
                    TextField(
                      ...
                      keyboardType: TextInputType.text,
                      decoration: const InputDecoration(
                        labelText: "your Motorcycle Number",
                        labelStyle: TextStyle(
                          fontSize: 14,
                        ),
                      ),
